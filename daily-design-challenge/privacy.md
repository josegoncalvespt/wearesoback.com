...
description: How Daily Design Challenge handles your information.
---
...
We Are So Back Ltd, Cyprus. Contact: **josemarquezgoncalves@gmail.com**.
...
| [Supabase](https://supabase.com/privacy) | Host public content (challenges, videos, profiles) | IP address from read requests; we send no personal data |
| [YouTube CDN (`img.youtube.com`)](https://policies.google.com/privacy) | Video thumbnails | IP address and standard request data when a thumbnail loads |
| [Apple iTunes Search API](https://www.apple.com/legal/privacy/) | Fetch artwork for referenced apps | IP address and standard request data |
| [unavatar.io](https://unavatar.io) | Avatar images for referenced X / Twitter profiles | IP address and standard request data |
...
To exercise any right, email **josemarquezgoncalves@gmail.com**. We respond within 30 days.
...
- **Your rights:** to know, delete, correct, and non-discrimination. To exercise, email josemarquezgoncalves@gmail.com.
...
The full revision history of this Policy is public in the [Git history of the page source](https://github.com/josegoncalvespt/wearesoback.com/commits/main/daily-design-challenge/privacy.md).
