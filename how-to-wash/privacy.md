...
description: How How to Wash handles your information.
---

_Last updated: 2026-05-30_

This Privacy Policy explains how **We Are So Back Ltd** ("we", "us"), a company registered in the Republic of Cyprus, handles information when you use **How to Wash: Stain Solver** (the "App").

## TL;DR

- No accounts, no sign-up.
- No analytics, advertising, or tracking SDKs.
- No network calls for any core feature. Care-label decoding, stain advice, and your scan history all run on your device.
- Photos of your labels and stains never leave your device.
...
- Your scan history, including photos of care labels and stains, recognised symbols, fabric content, stain notes, and wardrobe tags (via `SwiftData` and the iOS file system).
- Local diagnostic reports from Apple's MetricKit framework (crash and hang reports). These stay on-device unless you choose to share one yourself via the iOS share sheet.
...
That is the full list. The App contains no sign-in, no profiles, no backend servers operated by us, no analytics SDKs, no third-party crash-reporting SDKs, no ad networks, and no tracking technologies. The App's care-label OCR, symbol matching, and stain-advice composition all run locally using Apple's Vision framework and bundled content.

## Camera and photo library

The App requests access to your **camera** to capture care labels and stains, and optionally to your **photo library** if you choose to import an existing photo. These photos are processed on-device by Apple's Vision framework and stored on-device in your scan history. We do not transmit them anywhere.

## Information we may collect in the future

We may, in the future, introduce **privacy-respecting diagnostic or aggregate analytics** (for example, an opt-in upload of MetricKit reports, or a first-party privacy-preserving analytics provider) to help us improve stability and usability. If we do:
...
You can delete all device-side data — including every scanned photo, note, and history entry — by uninstalling the App.
...
All network requests use HTTPS. Because we hold no personal data on our own servers, and because the App's core features do not transmit data, there is no centralised user dataset on our side. Our service providers maintain their own security programmes and certifications.
...
The full revision history of this Policy is public in the [Git history of the page source](https://github.com/josegoncalvespt/wearesoback.com/commits/main/how-to-wash/privacy.md).
