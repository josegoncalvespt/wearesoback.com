...
description: The agreement between you and We Are So Back Ltd for using How to Wash.
---

_Last updated: 2026-05-30_

These Terms of Service ("Terms") are a legal agreement between you and **We Are So Back Ltd** ("we", "us"), a company registered in the Republic of Cyprus, governing your use of the **How to Wash: Stain Solver** iOS app (the "App"). By downloading, installing, or using the App, you agree to these Terms. If you do not agree, do not use the App.

## 1. The App

The App decodes ISO 3758 care-label symbols and prescribes stain-treatment steps for common fabrics and stains. It runs on iPhone (iOS 26.0 and later). Core scanning and advice features run **entirely on your device** with no internet connection. A paid subscription unlocks additional features as described in the App.

## 2. Not professional advice

The App provides general laundry-care information based on standard ISO 3758 symbol meanings and widely accepted treatment practices. **It is not a substitute for professional dry cleaning or the manufacturer's instructions on the garment itself.** Always check the physical care label on your item. We do not guarantee that following advice in the App will remove any specific stain or preserve any specific garment. You assume all risk for any treatment you apply.
...
(e) use the App to violate any law or any third-party right;
(f) impersonate any person or misrepresent your affiliation.

We may suspend or terminate your access for breach.

## 7. Your content (photos and notes)

The App lets you capture photos of care labels and stains, and write notes against your scan history. These are stored **only on your device** using iOS local storage (SwiftData) and the iOS file system. We do not upload, access, or process these photos or notes. You retain all rights to your content. Uninstalling the App permanently deletes it.
...
THE APP IS PROVIDED "AS IS" AND "AS AVAILABLE," WITH ALL FAULTS AND WITHOUT WARRANTY OF ANY KIND. TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, WE DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, ACCURACY, QUIET ENJOYMENT, AND NON-INFRINGEMENT. WITHOUT LIMITING THE FOREGOING, WE DO NOT WARRANT THAT THE APP'S CARE-LABEL DECODING OR STAIN-TREATMENT ADVICE IS COMPLETE, ACCURATE, OR SUITABLE FOR ANY PARTICULAR GARMENT.
...
IN NO EVENT WILL WE BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE DAMAGES, OR FOR LOST PROFITS, REVENUES, OR DATA, OR FOR DAMAGE TO ANY GARMENT OR PROPERTY ARISING FROM YOUR USE OF THE APP, EVEN IF WE WERE ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
...
The full revision history is public in the [Git history of the page source](https://github.com/josegoncalvespt/wearesoback.com/commits/main/how-to-wash/terms.md).
...
- **Entire agreement.** These Terms, together with the [Privacy Policy](/how-to-wash/privacy/), are the entire agreement between you and us regarding the App.
