...
description: The agreement between you and We Are So Back Ltd for using Watchword.
---

_Last updated: 2026-06-05_

These Terms of Service ("Terms") are a legal agreement between you and **We Are So Back Ltd** ("we", "us"), a company registered in the Republic of Cyprus, governing your use of the **Watchword** iOS app (the "App"). By downloading, installing, or using the App, you agree to these Terms. If you do not agree, do not use the App.

## 1. The App

The App gives a family a shared code word that rotates on a schedule, as a way to help verify that a caller claiming to be a family member really is one. Words are derived **on your device** from a secret shared within your family through Apple's iCloud sharing. It runs on iPhone (iOS 26.0 and later) and requires an iCloud account. A paid subscription unlocks the App as described in the App.

## 2. No guarantee of protection

**The App is a safety aid, not a guarantee.** It cannot prevent all scams, impersonation, or fraud. A code word only helps if your family sets it up, keeps it private, and actually asks for it — and even then, a determined attacker may succeed by other means. **Never rely on the App as your only check.** If a call feels wrong, hang up and call the person back on a number you know. We are not responsible for any loss arising from fraud, scams, or impersonation, whether or not the App was used as intended.
...
The App offers an **auto-renewable subscription**. The subscription title, length of period, features unlocked, and price (including any introductory pricing) are shown to you in the App before you purchase.
...
- **Manage and cancel:** Manage your subscription in **Settings → Apple ID → Subscriptions** on your device, or at [apps.apple.com/account/subscriptions](https://apps.apple.com/account/subscriptions). Cancelling stops auto-renewal; you keep access until the end of your current period.
- **Free trials**, where offered: any unused portion of a free trial is forfeited when you purchase a subscription.
- **Refunds:** all purchases are processed by Apple. Refunds are handled exclusively by Apple under the App Store Terms of Service. Request a refund at [reportaproblem.apple.com](https://reportaproblem.apple.com). We cannot issue refunds directly.
...
(a) reverse engineer, decompile, or disassemble the App except where permitted by applicable law;
(b) use automated systems (bots, scrapers, crawlers) to access the App or its content;
(c) circumvent paywalls, license checks, or rate limits;
(d) resell, sublicense, or redistribute the App or its content;
(e) use the App to violate any law or any third-party right, or to deceive, harass, or impersonate any person;
(f) invite people into a family circle without their knowledge and consent.

We may suspend or terminate your access for breach.

## 7. Your family circle and content

Family names, member names, and your family's shared secret are yours. They are stored on your devices and in your family's own iCloud, as described in the [Privacy Policy](/watchword/privacy/). We do not upload, access, or process them on any server of ours. The family member who created the circle controls it, including removing members and deleting the circle. Uninstalling the App and leaving the family share deletes your copy.
...
THE APP IS PROVIDED "AS IS" AND "AS AVAILABLE," WITH ALL FAULTS AND WITHOUT WARRANTY OF ANY KIND. TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, WE DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, ACCURACY, QUIET ENJOYMENT, AND NON-INFRINGEMENT. WITHOUT LIMITING THE FOREGOING, WE DO NOT WARRANT THAT THE APP WILL PREVENT ANY SCAM, FRAUD, OR IMPERSONATION, OR THAT CODE WORDS WILL ALWAYS BE AVAILABLE OR IN SYNC ON EVERY DEVICE.
...
IN NO EVENT WILL WE BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE DAMAGES, OR FOR LOST PROFITS, REVENUES, OR DATA, OR FOR ANY LOSS ARISING FROM FRAUD, SCAMS, OR IMPERSONATION BY THIRD PARTIES, EVEN IF WE WERE ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
...
You may stop using the App and cancel your subscription at any time. We may suspend or terminate your access for breach of these Terms, for legal or regulatory reasons, or if continuing to provide the App becomes impractical. Sections 6–13 survive termination.
...
The full revision history is public in the [Git history of the page source](https://github.com/josegoncalvespt/wearesoback.com/commits/main/watchword/terms.md).
...
- **Entire agreement.** These Terms, together with the [Privacy Policy](/watchword/privacy/), are the entire agreement between you and us regarding the App.
